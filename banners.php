...
<form method="post" enctype="multipart/form-data">
	...
	<p>
		<label><?=$lang['b_175']?></label> <small style="float:right">Your banner must measure <b><font size="3" color="green">468x60</font></b> px</small>
...
$color = ($x%2) ? 3 : 1;
?>
    <tr class="c_<?=$color?>"><td><a href="<?=$banner['site_url']?>" title="<?=$banner['site_url']?>" target="_blank"><img src="<?=$banner['banner_url']?>" width="312" border="0" /></a></td><td><?=$banner['views']?></td><td><?=$banner['clicks']?></td><td><?=$status?></td><td><?if($banner['status'] != 2){?><a class="bluebut" href="banners.php?edit=<?=$banner['id']?>"><?=$lang['b_96']?></a><?}?></td></tr>
<?}?>
	</tbody>
</table>
</div>
