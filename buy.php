...
<h2 class="title"><?=$lang['b_247']?> <span style="float:right"><a class="bbut" href="buy.php"><?=$lang['b_07']?></a></span></h2>
	<table class="table">
		<thead>
			<tr>
				<td><?=$lang['b_248']?></td>
...
<div class="content">
<div class="infobox" style="text-align:left;width:700px;margin:10px auto;display:inline-block;font-size;font-size:30px"><b>You have:  <span style="font-weight:600;color:green;font-size:50px"><?=$data['account_balance']?> $</span></b></div>
<h2 class="title"><?=$lang['b_07']?> <span style="float:right"><a class="bbut" href="buy.php?history"><?=$lang['b_247']?></a></span></h2><?=$msg?>
<?
