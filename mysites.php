...
<SCRIPT LANGUAGE="JavaScript1.1" SRC="http://bdv.bidvertiser.com/BidVertiser.dbm?pid=552347&bid=1384492" type="text/javascript"></SCRIPT>
...
$color = ($x%2) ? 3 : 1;
?>
    <tr class="c_<?=$color?>"><td><?=truncate($mysite['title'], 50)?></td><td><?=$mysite['clicks']?></td><td><?=$mysite['cpc']?></td><?if($target_system){?><td align="center"><?=$rec?></td><?}?><td><?=$status?></td><td><?if($mysite['active'] != 2){?><a style="font-size:13px" class="bluebut" href="editsite.php?x=<?=$mysite['id']?>&t=<?=$page?>"><?=$lang['b_96']?></a><?}?></td></tr>
<?}?>
	</tbody>
    </table>
</div>
